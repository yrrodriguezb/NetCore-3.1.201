...
namespace DDD.Tests
{
    ...
    {
        [Fact]
        public void Sum_of_two_moneys_prodices_correct_result()
        {
            // Arrange
        ...
        [Fact]
        public void The_money_instances_equal_if_contain_the_same_money_amount()
        {
            Money money1 = new Money(1, 2, 3, 4, 5, 6);
            Money money2 = new Money(1, 2, 3, 4, 5, 6);
        ...
        [Fact]
        public void The_money_instances_do_not_equal_if_contain_different_money_amounts()
        {
        ...
        public void Substraction_of_two_moneys_produces_correct_result()
        {
            ...
            result.QuaterCount.Should().Be(7);
